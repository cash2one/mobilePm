...
<%
	...
	Page casePage = articleDao.getArticlePage(1, 12, "6");
...
<body>
					...
					<div class="k_hot">
						...
						<ul class="top5box">
							<%
								int position = 1;
								while (caseRs.next()) {
									String listPreview = LAB.replaceNull(caseRs.getString("a_preview"));
									String listTitle = caseRs.getString("a_title");
									String listAuthor = caseRs.getString("a_author");
									String listTime = caseRs.getString("a_time").substring(0, 10);
									int listId = caseRs.getInt("a_id");
									String classStr = "";
									if(position<=5)
										classStr="hover";
							%>
							<li class="<%=classStr %>">
								<div class="pic">
									<a href="details.jsp?id=<%=listId%>"><img src="<%=listPreview%>"></a>
								</div>
								<div class="title">
	...
	<script type="text/javascript">
		$(function() {
			Fengs.use('940/utils/popBox', function(d) {
				d.init();
