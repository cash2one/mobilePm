...
<div class='r_content'>
			...
			<div class='center_cont edit'>
				...
				<form id="article_form" action="../videoEditSubmit" name="article_form"	method="post">
					...
					<table>
						...
						<tr>
							<td class="td1">分类：</td>
							<td width="50"><select id="type" name="type" onchange="changeSelected(this.value)">  
						...
						<tr>
							...
							<td width="200"><input type="text" id="a_content" name="a_content"	value="<%=content%>"></td>
							<td class="td1">预览图：</td>
							<td><input type="text"   id="preview" name="preview" value="<%=preview%>"></td>
						...
						<tr>
							...
							<td class="td1">优先级：</td>
							<td width="290"><input style="width:100px;padding-right:0;" type="number" id="priority" name="priority"	value="<%=priority%>"><i>（数字越大优先级越高）</i></td>
						</tr>
						<tr>
							<td class="td1">作者：</td>
							<td><input type="text" id="author"	name="author" value="<%=author%>"></td>
							<td class="td1">时间：</td>
							<td><input style="width:150px;" type="text" id="time" name="time" value="<%=time%>"><i>（格式：2016-01-01 00:00）</i></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
