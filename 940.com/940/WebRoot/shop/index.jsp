		...
		<div id="wrapShop">
			...
			<ul class='kd_list_ul'>
				<li>
					...
					<div class='kd_box'>
						...
						<a class='topa a<%=sIndex++ %>' href="/shop/jiqiao/<%=id+".html"%>">
						...
						<a class='linka' href="/shop/jiqiao/<%=id+".html"%>">查看详情</a>
					...
					<dl class='fr kd_dl'>
						...
						%>
						<dt>
							<a href="/shop/jiqiao/<%=id+".html"%>"><%=title%></a>
						</dt>
						<%
							} else {
						%>
			...
			<ul class='kd_list_ul'>
				<li>
					...
					%>
					<div class='kd_box'>
						<a class='topa a<%=sIndex++ %>' href="/shop/fenxiang/<%=id+".html"%>">
							<em class='fl'><img src="<%=preview%>"></em> <span
							class='fl'> <strong>今日推荐</strong><br /> <i><%=title%></i>
						</span>
						</a>
						...
						<a class='linka' href="/shop/fenxiang/<%=id+".html"%>">查看详情</a>
					</div> <%
 	} 
 ...
 %>
			...
			<ul class='kd_list_ul'>
				<li>
					...
					%>
					<div class='kd_box'>
						<a class='topa a<%=sIndex %>' href="/shop/tuiguang/<%=id+".html"%>">
							<em class='fl'><img src="<%=preview%>"></em> <span
							class='fl'> <strong>今日推荐</strong><br /> <i><%=title%></i>
						</span>
						</a>
						...
						<a class='linka' href="/shop/tuiguang/<%=id+".html"%>">查看详情</a>
