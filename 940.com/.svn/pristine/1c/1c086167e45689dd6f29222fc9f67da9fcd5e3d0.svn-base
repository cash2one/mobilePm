...
<%
	...
	Page skillPage = articleDao.getArticlePage(1, 12, "2");
					...
					<div class="k_hot">
						...
						<ul class="top5box">
							<%
								int position = 1;
								while (skillRs.next()) {
									String listPreview = LAB.replaceNull(skillRs
											.getString("a_preview"));
									String listTitle = skillRs.getString("a_title");
									String listAuthor = skillRs.getString("a_author");
									String listTime = skillRs.getString("a_time").substring(0, 10);
									int listId = skillRs.getInt("a_id");
									String classStr = "";
									if (position <= 5)
										classStr = "hover";
							%>
