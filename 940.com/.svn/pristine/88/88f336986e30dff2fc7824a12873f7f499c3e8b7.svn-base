Fengs.add('kehuda/mobile/anli', function(S, $, ui, req){
	var minCount = 18
		, lineCount = 3;
	$(document).ready(function(){
		...
		// 		d = d.kehuda;
		// 		if(d.status == 1){
		// 			var list=d.list.l,liHtml = '',imgSrc;
		...
		// 					imgSrc = 'b_cap_' + (_l-15);
		// 				}
		// 				liHtml+='<li><div class="kd_info"><img src="/images/an_bg.png"><p class="p_credit"><img src="/images/rank/'+imgSrc+'.gif"></p><p class="p_name">'+obj.w+'</p><a target="_blank" class="a_link" href="'+obj.u+'">点击查看</a></div></li>'
		// 			});
