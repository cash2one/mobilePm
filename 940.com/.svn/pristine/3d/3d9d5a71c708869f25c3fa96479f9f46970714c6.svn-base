...
<%
	...
	if (userName != null && userName.equals("940") && password != null
		...
		if (go.equals(""))
			...
			pageNum = SYS.RequestString(request, "page");
			go += "?page=" + pageNum;
		}else if(go.contains("feedback_manager_list")){
			go += ".jsp";
			pageNum = SYS.RequestString(request, "page");
			go += "?page=" + pageNum;
		}
		...
		}else if(go.contains("feedback_edit")){
			go += ".jsp";
			String doStr = SYS.RequestString(request, "do");
			if (doStr.equals("edit")) {
				id = SYS.RequestString(request, "id");
...
<body>
	...
	<div id="header">
		...
		<div class='fr admin'>
			<p class='link'>
				<a href="${pageContext.request.contextPath}/manager_index/manager_index.jsp">后台首页</a>|
				<a href="">修改密码</a>|
				<a style="padding-right:0" href="${pageContext.request.contextPath}/">访问官网</a>
			</p>
			<div class='account'>
				<a href="" class="a1">940.com</a>
				<a href="${pageContext.request.contextPath}/manager_index/login.jsp" class="a2">退出</a>
			</div>
		</div>
	</div>
	<div id="content">
		<div class='fl l_menu'>
			<ul class='menu_ul'>
				<%
					...
					String articleStr="",videoStr="",noticeStr="",reginfoStr="",shareStr="",teacherStr="",feedbackStr="";
				...
				<li class='li7'><a class='<%=feedbackStr %>' href="manager_index.jsp?go=feedback_manager_list&page=1">反馈管理</a></li>
			</ul>
		</div>
		<%
	if (go != null) {
