...
<%
	...
	Page videoPage = videoDao.getVideoPage(1, 9, "2", "");
		...
		<div class='wrap_slide'>
			...
			<div class='wrap_pic slide_2'>
				<div class='j_com j_wrap j_pic_2'>
					...
					<div class='s2_but'>
						<a class='fl enroll' href="javascript:"><i>“</i>我要当老板<i>”</i></a>
						<a class='fr enroll' href="javascript:">立即报名</a>
					</div>
			...
			<div class='fl cases'>
				...
				<ul class="ul_list_cont">
					...
					<li>
						<dl class="case_stu">
							<dt>
								<a href="/case/details.jsp?id=<%=id%>"><img
									src="<%=preview%>"></a>
							</dt>
							<dd class="txt">
								<a href="/case/details.jsp?id=<%=id%>"><%=title%></a>
							</dd>
							<dd class="money">
