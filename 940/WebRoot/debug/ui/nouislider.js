Fengs.add('ui/nouislider', function(S, f) {
    return noUiSlider = function(n, r) {
    	var minNumber = 0
    		, maxNumber = 0;
        function s(a, e, c) {
            var g = e.data("setup"),
            ...
            create: function() {
                return this.each(function() {
                    ...
                    for (b = 0; b < a.handles; b++) {
                        c[b] = e.append("<a class='n"+ b +"'><div></div></a>").children(":last");
                                ...
                                function(b) {
                                    ...
                                    if ("x" != b[0]) {
                                        ...
                                        if (p[l] && f != n) {
                                            ...
                                            d.css(g, f + "%").data("input", m.is(a.range, f).toFixed(q));
                                            var p = a.slide,
                                            h = e.data("_n", !0);
                    ...
                    "string" == typeof a.serialization.to[b] ? c[b].data("input", 
                    	e.append('<input type="hidden" name="' + a.serialization.to[b] + '">').find("input:last").val(k).change(function(a) {
                        a.stopPropagation()
					...
					for (b = 0; b < c.length; b++) k = m.is(a.range, parseFloat(c[b][0].style[g])).toFixed(q),
                    "string" == typeof a.serialization.to[b] ? c[b].data("input",k) : !1 == a.serialization.to[b] ? c[b].data("input", {
                        val: function(a) {
                            if ("undefined" != typeof a) this.handle.data("noUiVal", a);
                            else return this.handle.data("noUiVal")
                        },
                ...
                if ("undefined" !== typeof a) {
                    ...
                    return this.each(function() {
                        for (var a = f(this).data("setup"), b = 0; b < a.handles.length; b++) if (null != e[b]) {
                            ...
                            a.handles[b].css(a.pos, c + "%").data("input", m.is(a.settings.range, c).toFixed(a.res))
                        }
                    })
                }
                a = f(this).data("setup").handles;
                for (var c = [], g = 0; g < a.length; g++) c.push(parseFloat(a[g].data("input")));
